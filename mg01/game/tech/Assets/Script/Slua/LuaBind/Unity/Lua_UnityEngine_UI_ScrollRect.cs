...
public class Lua_UnityEngine_UI_ScrollRect : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_horizontalNormalizedPosition2(IntPtr l) {
		try {
			UnityEngine.UI.ScrollRect self=(UnityEngine.UI.ScrollRect)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.horizontalNormalizedPosition2);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_verticalNormalizedPosition2(IntPtr l) {
		try {
			UnityEngine.UI.ScrollRect self=(UnityEngine.UI.ScrollRect)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.verticalNormalizedPosition2);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"horizontalNormalizedPosition2",get_horizontalNormalizedPosition2,null,true);
		addMember(l,"verticalNormalizedPosition2",get_verticalNormalizedPosition2,null,true);
