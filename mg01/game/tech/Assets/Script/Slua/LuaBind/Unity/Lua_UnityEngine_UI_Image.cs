...
public class Lua_UnityEngine_UI_Image : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_overlayColor(IntPtr l) {
		try {
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.overlayColor);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_overlayColor(IntPtr l) {
		try {
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			UnityEngine.Color v;
			checkType(l,2,out v);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_enablePolygon(IntPtr l) {
		try {
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.enablePolygon);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_enablePolygon(IntPtr l) {
		try {
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			bool v;
			checkType(l,2,out v);
			self.enablePolygon=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"overlayColor",get_overlayColor,set_overlayColor,true);
		addMember(l,"slicedFilled",get_slicedFilled,set_slicedFilled,true);
		addMember(l,"enablePolygon",get_enablePolygon,set_enablePolygon,true);
