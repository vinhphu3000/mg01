...
public class Lua_mg_org_GameObjUtil : LuaObject {
	...
	static public int DontDestroyOnLoad_s(IntPtr l) {
		try {
			...
			mg.org.GameObjUtil.DontDestroyOnLoad(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int FindChild_s(IntPtr l) {
		try {
			...
			var ret=mg.org.GameObjUtil.FindChild(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int FuzzySearchChild_s(IntPtr l) {
		try {
			UnityEngine.GameObject a1;
			checkType(l,1,out a1);
			System.String a2;
			checkType(l,2,out a2);
			var ret=mg.org.GameObjUtil.FuzzySearchChild(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
