...
/////// Vectors:
                ...
                float scale = saturate(((_AlphaClipRGBA_var.a*_EdgeClip)*i.vertexColor.a - 0.5) * 100);
////// Lighting:
////// Emissive:
                float3 emissive = (_BaseColor.rgb*_AlphaClipRGBA_var.rgb);
                float3 finalColor = emissive * scale;
                return fixed4(finalColor,scale);
            }
            ENDCG
        }
    }
