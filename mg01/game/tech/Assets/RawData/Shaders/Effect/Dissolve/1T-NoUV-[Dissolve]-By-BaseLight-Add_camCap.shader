...
Shader "EJoyShader/Effect/Dissolve/1T-NoUV-[Dissolve]-By-BaseLight-Add_camCap" {
Properties {
	_CamCapture("Base Texture", 2D) = "white" {}		// 颜色贴图
...
Category {
	...
	SubShader {
		Pass {
			...
			{
				float4 mainTex = tex2D(_CamCapture, i.texcoord);
