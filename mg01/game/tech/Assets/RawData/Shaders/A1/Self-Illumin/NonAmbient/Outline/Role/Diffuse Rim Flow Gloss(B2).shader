Shader "A1/Self-Illumin/Non Ambient/Outline/Role/Diffuse Rim Flow (Gloss B2)" {
Properties
{
	...
	_LightParams_x ("Intensity (X)", float) = 6
	_LightParams_y ("Power (Y)", float) = 8
...
SubShader
{
	...
	fixed3 _LightColor;
	// fixed2 _LightParams;
	float _LightParams_x;
	float _LightParams_y;
	...
	void surf (Input IN, inout SurfaceOutput o)
	{
		...
		fixed3 rimcolor = _LightParams_x * c * _LightColor * pow (factor, _LightParams_y);
