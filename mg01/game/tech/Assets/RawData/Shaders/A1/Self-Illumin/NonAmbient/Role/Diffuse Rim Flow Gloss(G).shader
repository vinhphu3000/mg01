Shader "A1/Self-Illumin/Non Ambient/Role/Diffuse Rim Flow (Gloss G)" {
Properties
{
...
SubShader
{
	Tags { "RenderType"="Opaque" "Complexity"="6" }
	LOD 200
	...
	void surf (Input IN, inout SurfaceOutput o)
	{
		...
		fixed gloss = tex2D(_GlossTex, IN.uv_MainTex).g;
...
Fallback "A1/Self-Illumin/Non Ambient/Role/Diffuse Rim"
}
