Shader "Nature/Terrain/Diffuse" {
	...
	Dependency "Details0"      = "Legacy Shaders/Diffuse"
	Dependency "Details1"      = "Legacy Shaders/Diffuse"
	Dependency "Details2"      = "Legacy Shaders/Diffuse"
	Dependency "Tree0"         = "Legacy Shaders/Diffuse"
