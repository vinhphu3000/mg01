...
namespace UnityEngine.UI
{
    public abstract class MaskableGraphic : Graphic, IClippable, IMaskable, IMaterialModifier
    {
        ...
        /// <summary>
        /// Cache mask on awake, saving a lot of gc alloc memory while OnEnable/OnDisable's GetComponent
        /// https://bitbucket.org/Unity-Technologies/ui/pull-requests/54/reduce-the-invoke-getcomponent-when/diff
        /// </summary>
        /// 

        [NonSerialized]
        protected internal Mask m_Mask;
