...
namespace UnityEditor.UI
{
    ...
    public class ImageEditor : GraphicEditor
    {
        ...
        SerializedProperty m_OverlayColor;
        ...
        protected override void OnEnable()
        {
            ...
            m_OverlayColor = serializedObject.FindProperty("m_OverlayColor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(m_OverlayColor != null) EditorGUILayout.PropertyField(m_OverlayColor);
            if(m_Alpha != null) EditorGUILayout.PropertyField(m_Alpha);
